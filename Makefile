...
$(BUILD_DIR)/main: main.cpp cfg/CFGParser.cpp cfg/CFGParser.hpp cfg/CFG.hpp plustimes/ptfromcfg.cpp plustimes/plustimes.hpp algorithm/algorithm.cpp algorithm/algorithm.hpp utils/alg_checks.cpp utils/alg_checks.hpp | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) main.cpp cfg/CFGParser.cpp plustimes/ptfromcfg.cpp algorithm/algorithm.cpp utils/alg_checks.cpp -o $@

$(BUILD_DIR)/maing: main.cpp cfg/CFGParser.cpp cfg/CFGParser.hpp cfg/CFG.hpp plustimes/ptfromcfg.cpp plustimes/plustimes.hpp algorithm/algorithm.cpp algorithm/algorithm.hpp utils/alg_checks.cpp utils/alg_checks.hpp | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) main.cpp cfg/CFGParser.cpp plustimes/ptfromcfg.cpp algorithm/algorithm.cpp utils/alg_checks.cpp -g -o $@
